...
export const ClubBuy = styled.div((props: StyledClubBuyProps): FlattenSimpleInterpolation => css`
  text-align: center;
  border-bottom: 1px solid ${props.theme.colours.grey};
`)

export const Products = styled.div((props: StyledClubBuyProps): FlattenSimpleInterpolation => css`
  display: grid;
  grid-template-columns: repeat(2, 1fr);
  margin-top: ${props.theme.spacing[6]}px;
`)

export const Product = styled.div((props: StyledClubBuyProps): FlattenSimpleInterpolation => css`
  display: flex;
