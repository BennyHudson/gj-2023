...
export const Meta = styled.div((props: StyledMetaProps): FlattenSimpleInterpolation => css`
...
export const Date = styled.span((props: StyledMetaProps): FlattenSimpleInterpolation => css`
