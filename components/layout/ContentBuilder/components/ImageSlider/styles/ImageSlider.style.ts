...
export const Slide = styled.div((props: StyledImageSliderProps): FlattenSimpleInterpolation => css`
  padding: 0 ${props.theme.spacing[1]}px;
  transition: 0.4s all ease;
`)

export const ImageSlider = styled.div((props: StyledImageSliderProps): FlattenSimpleInterpolation => css`
