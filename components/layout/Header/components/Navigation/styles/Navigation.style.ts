...
import { PostGrid } from '@components/grids/PostGrid/styles/PostGrid.style'
import { Heading } from '@components/typography/Heading/styles/Heading.style'
import { Meta } from '@components/typography/Meta/styles/Meta.style'
...
export const Navigation = styled.nav((): FlattenSimpleInterpolation => css`
  display: flex;
  align: center;
...
export const SubMenu = styled.ul((props: StyledNavigationProps) => css`
  display: grid;
...
export const SubMenuList = styled.ul((): FlattenSimpleInterpolation => css`
  display: flex;
  flex-direction: column;
`)

export const SubLink = styled(Link)((props: StyledNavigationProps) => css`
...
export const MainMenu = styled.ul((props: StyledNavigationProps) => css`
  display: flex;
  align-items: center;
  justify-content: center;
