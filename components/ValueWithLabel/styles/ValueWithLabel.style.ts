...
export const ValueWithLabel = styled.div((props: StyledValueWithLabelProps): FlattenSimpleInterpolation => css`
  display: flex;
...
export const Label = styled.span((): FlattenSimpleInterpolation => css`
