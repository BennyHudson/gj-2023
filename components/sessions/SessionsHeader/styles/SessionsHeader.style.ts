...
import { PostExcerpt } from '@components/grids/PostExcerpt/styles/PostExcerpt.style'

import { StyledSessionsHeaderProps } from './SessionsHeader.style.types'
import { Section } from '@components/layout/Section/styles/Section.style'
...
export const Feature = styled.div((): FlattenSimpleInterpolation => css`
  grid-column: col-start / span 9;
`)

export const SecondaryPosts = styled.div((props: StyledSessionsHeaderProps): FlattenSimpleInterpolation => css`
  display: flex;
