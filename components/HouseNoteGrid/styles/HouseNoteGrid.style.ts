...
export const HouseNoteExcerpt = styled.div((props: StyledHouseNoteGridProps): FlattenSimpleInterpolation => css`
  display: flex;
...
export const HouseNoteGrid = styled.div((props: StyledHouseNoteGridProps): FlattenSimpleInterpolation => css`
  .my-masonry-grid {
    display: flex;
