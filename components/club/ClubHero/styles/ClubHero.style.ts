...
export const ClubHero = styled.div((props: StyledClubHeroProps): FlattenSimpleInterpolation => css`
  background: #202020;
...
export const HeroContent = styled.div((): FlattenSimpleInterpolation => css`
  width: 40%;
`)
