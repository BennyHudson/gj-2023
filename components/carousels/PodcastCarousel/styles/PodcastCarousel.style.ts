...
import { PodcastCard } from '@components/podcast/PodcastCard/styles/PodcastCard.style'

import { StyledPodcastCarouselProps } from './PodcastCarousel.style.types'

export const PodcastCarousel = styled.div((props: StyledPodcastCarouselProps): FlattenSimpleInterpolation => css`
