...
export const AffiliateProductBlock = styled.div((props: StyledAffiliateProductBlockProps): FlattenSimpleInterpolation => css`
...
export const Product = styled.div((props: StyledAffiliateProductBlockProps): FlattenSimpleInterpolation => css`
  display: flex;
