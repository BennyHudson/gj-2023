...
export const VideoWrapper = styled.div((props: StyledHeroImageProps): FlattenSimpleInterpolation => css`
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
export const Video = styled.div((props: StyledHeroImageProps): FlattenSimpleInterpolation => css`
