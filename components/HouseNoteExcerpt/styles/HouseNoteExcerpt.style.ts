...
export const Footer = styled.div((props: StyledHouseNoteExcerptProps): FlattenSimpleInterpolation => css`
  display: flex;
  justify-content: space-between;
  gap: ${props.theme.spacing[2]}px;
`)

export const Body = styled.div((props: StyledHouseNoteExcerptProps): FlattenSimpleInterpolation => css`
  width: 90%;
  margin: 0 auto;
  display: flex;
  flex-direction: column;
