...
export const PaymentDetails = styled.div((props: StyledPaymentDetailsProps): FlattenSimpleInterpolation => css`
  display: flex;
...
export const PaymentForm = styled.div((): FlattenSimpleInterpolation => css`
  width: 100%;
`)