...
export const PostTitle = styled.div((props: ThemeProps): FlattenSimpleInterpolation => css`
  display: flex;
  flex-grow: 1;
  flex-direction: column;
...
export const Slider = styled.div((props: StyledFeatureCarouselProps): FlattenSimpleInterpolation => css`
  position: absolute;
...
export const Slide = styled.div((props: StyledFeatureCarouselProps): FlattenSimpleInterpolation => css`
  position: relative;
  height: 100%;
