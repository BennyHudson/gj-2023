...
export const MobileNavigation = styled.nav((props: StyledMobileNavigationProps): FlattenSimpleInterpolation => css`
  position: fixed;
...
export const MainMenu = styled.ul((props: StyledMobileNavigationProps) => css`
  display: flex;
...
export const SubMenu = styled.ul((props: StyledMobileNavigationProps) => css`
  display: grid;
...
export const SubLink = styled(Link)((props: StyledMobileNavigationProps) => css`
